...
var LOCAL_STORAGE_MESSAGE_KEY = 'daysSinceMessage';
var LOCAL_STORAGE_TIMESTAMP_KEY = 'daysSinceTimestamp';
exports.default = vue_1.default.extend({
  ...
  methods: {
    ...
    persistData: function persistData(key, value) {
  ...
  computed: {
    persistedMessageItem: function persistedMessageItem() {
  ...
  mounted: function mounted() {
    ...
    this.retrievePersistedData();
      ...
      if (typeof $f1616a === 'function') {
        $f1616a = $f1616a.options;
      }
    
        /* template */
        Object.assign($f1616a, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c("div", { staticClass: "editor" }, [
      _c("span", { staticClass: "edit", on: { click: _vm.toggleEditor } }, [
        _vm._v("Edit")
      ]),
      _vm._v(" "),
      _vm.isEditorShown
        ? _c("div", { staticClass: "panel" }, [
            ...
            _c(
              "button",
              { staticClass: "button save", on: { click: _vm.toggleEditor } },
              [_vm._v("Save")]
            )
          ])
        : _vm._e()
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f1616a', $f1616a);
          } else {
            api.reload('$f1616a', $f1616a);
          }
        }
...
//# sourceMappingURL=/days-since-counter.e31bb0bc.js.map